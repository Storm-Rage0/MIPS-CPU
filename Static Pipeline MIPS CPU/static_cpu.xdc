...
set_property IOSTANDARD LVCMOS33 [get_ports {array_choose[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {array_choose[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {item_choose[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {item_choose[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {item_choose[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {item_choose[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {item_choose[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {item_choose[0]}]
set_property PACKAGE_PIN V10 [get_ports {array_choose[1]}]
set_property PACKAGE_PIN U11 [get_ports {array_choose[0]}]
set_property PACKAGE_PIN J15 [get_ports {item_choose[0]}]
set_property PACKAGE_PIN L16 [get_ports {item_choose[1]}]
set_property PACKAGE_PIN M13 [get_ports {item_choose[2]}]
set_property PACKAGE_PIN R15 [get_ports {item_choose[3]}]
set_property PACKAGE_PIN R17 [get_ports {item_choose[4]}]
set_property PACKAGE_PIN T18 [get_ports {item_choose[5]}]
